...
run: async (client, message, args, db, prefix) => {
      ...
      let entrada = moment.utc(message.guild.member(usuario).joinedAt).format("L") // data de entrada no servidor, da conta do usuário
      ...
      .setAuthor(`${usuario.tag} - userInfo`, usuario.displayAvatarURL({dynamic: true}))
